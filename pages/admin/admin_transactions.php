...
<html lang="en">
  <head>
    ...
    <title>Sofie's Corner | Transactions</title>
    <link
      rel="stylesheet"
          ...
          <div class="menu-wrapper py-3">
            <div class="menu">
              <ul class="menu-list">
                ...
                <li>
                  <a href="admin_transactions.php" class="is-active has-background-primary">
                ...
                <div class="control has-icons-left">
                  <div class="select is-link">
                    <select>
                      ...
                      <option>Ascending, 1-9</option>
                      <option>Descending, 9-1</option>
              ...
              <div class="card">
                ...
                <div class="card-content">
                  <div class="content">
                    ...
                    <label class="label">Item(s) Purchased</label>
                    <div class="level">
                      <div class="level-left">
                        <div class="level-item">
                          <p>Item 1</p>
